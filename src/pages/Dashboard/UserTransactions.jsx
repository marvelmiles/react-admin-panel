            ...
            <Grid container>
              <Grid item xs={12} s1024={5} variant="paper">
                <Button
                  ...
                  onClick={() => {
                    alert(
                      "Since this is a demo app visit source code at github.com/marvelmiles/react-admin-panel or route to /dashboard/users/new to have an idea of how firebase edit functionality work."
                    );
